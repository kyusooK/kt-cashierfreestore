    ...
    export default {
        ...
        data: () => ({
            ...
            headers: 
                [
                    ...
                    { text: "employeeIdCard", value: "employeeIdCard" },
                    { text: "enteringAt", value: "enteringAt" },
                    { text: "exitAt", value: "exitAt" },
                    { text: "availableStartAt", value: "availableStartAt" },
                    { text: "availableEndAt", value: "availableEndAt" },
                    { text: "userId", value: "userId" },
                    { text: "enterStatus", value: "enterStatus" },
                    { text: "availableTime", value: "availableTime" },
                ],
            store : [],
            newValue: {},
            tick : true,
        ...
        async created() {
            ...
            this.newValue = {
                'userName': '',
                'employeeIdCard': '',
                'enteringAt': '2025-03-04',
                'exitAt': '2025-03-04',
                'availableStartAt': '2025-03-04',
                'availableEndAt': '2025-03-04',
                'userId': {},
                'enterStatus': '',
                'availableTime': '',
            }
