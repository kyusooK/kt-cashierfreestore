<template>
    <div>
        <String label="이름" v-model="value.userName" :editMode="editMode"/>
        <String label="사원증" v-model="value.employeeIdCard" :editMode="editMode"/>
        <Date label="출입시간" v-model="value.enteringAt" :editMode="editMode"/>
