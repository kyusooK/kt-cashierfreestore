                ...
                <v-table>
                    ...
                    <tbody>
                        <tr v-for="(val, idx) in value" :key="val" @click="changeSelectedRow(val)" :style="val === selectedRow ? 'background-color: #f0f3ff;':''">
                            ...
                            <td class="whitespace-nowrap" label="입장시간">{{ val.enteringDate }}</td>
                            <td class="whitespace-nowrap" label="퇴장시간">{{ val.exitDate }}</td>
                            <td class="whitespace-nowrap" label="매장">
                                <StoreId :editMode="editMode" v-model="val.storeId"></StoreId>
                            </td>
            ...
            >
                <v-card>
                    <v-toolbar
                        ...
                        height="50px"
                    >
                        <div style="color:white; font-size:17px; font-weight:700;">StoreUsing 등록</div>
                        <v-spacer></v-spacer>
                        <v-icon
                            color="white"
                            small
            ...
            >
                <v-card>
                    <v-toolbar
                        ...
                        height="50px"
                    >
                        <div style="color:white; font-size:17px; font-weight:700;">StoreUsing 수정</div>
                        <v-spacer></v-spacer>
                        <v-icon
                            color="white"
                            small
