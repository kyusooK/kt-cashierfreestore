                ...
                <v-table>
                    ...
                    <tbody>
                        <tr v-for="(val, idx) in value" :key="val" @click="changeSelectedRow(val)" :style="val === selectedRow ? 'background-color: #f0f3ff;':''">
                            ...
                            <td class="whitespace-nowrap" label="사용자이름">{{ val.userName }}</td>
            ...
            >
                <v-card>
                    <v-toolbar
                        ...
                        height="50px"
                    >
                        <div style="color:white; font-size:17px; font-weight:700;">Authority 등록</div>
                        <v-spacer></v-spacer>
                        <v-icon
                            color="white"
                            small
            ...
            >
                <v-card>
                    <v-toolbar
                        ...
                        height="50px"
                    >
                        <div style="color:white; font-size:17px; font-weight:700;">Authority 수정</div>
                        <v-spacer></v-spacer>
                        <v-icon
                            color="white"
                            small
                    ...
                    <v-card-text>
                        <div>
                            <String label="사용자이름" v-model="selectedRow.userName" :editMode="true"/>
                            <String label="사용자 직급" v-model="selectedRow.rank" :editMode="true"/>
                            <String label="사용자 부서" v-model="selectedRow.department" :editMode="true"/>
                            <String label="이용가능 시간" v-model="selectedRow.availableTime" :editMode="true"/>
